...
<script>
import { CreateFoods, DeleteFoods, UpdateFoods, GetFoodsList } from '@/api/Foods'
...
export default {
  ...
  methods: {
    getList() {
      this.loading = true
      GetFoodsList(this.listQuery).then(response => {
    ...
    createData() {
      CreateFoods(this.temp).then(data => {
        this.$message({
    ...
    updateData() {
      UpdateFoods(this.temp).then(data => {
        this.$message({
          message: data.message,
          type: 'success'
        })
    ...
    handleDelete(row, index) {
      DeleteFoods({ id: row.id }).then((data) => {
        this.$message({
          message: data.message,
          type: 'success'
        })
